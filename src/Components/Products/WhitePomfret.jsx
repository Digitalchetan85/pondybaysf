...
import sampleFish from "../../Images/products/white-pomfret/image-1.png";

const WhitePomfretFish = (props) => {
      ...
      <div id="sample1" className="pt-3 pb-3 pt-md-5 pb-md-5">
        <Container>
          <Row>
            ...
            <Col md={8}>
              <div className="">
                <h2 className="pt-2 pb-2">White Promfet Fish</h2>
                <p className="">
...
export default WhitePomfretFish;
