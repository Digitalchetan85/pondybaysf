...
import sampleFish from "../../Images/products/red-snapper/image-1.png";


const RedSnapper = (props) => {
      ...
      <div id="sample1" className="pt-3 pb-3 pt-md-5 pb-md-5">
        <Container>
          <Row>
            ...
            <Col md={8}>
              <div className="">
                <h2 className="pt-2 pb-2">Red Snapper Fish</h2>
                <p className="">
